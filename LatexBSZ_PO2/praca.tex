...
%------------------------------------------------------------------------------
\author{Bartłomiej Kufel}
\shortauthor{B. Kufel}
\noAlbum{134936}

\titlePL{Rock Gym -- system zarządzania ścianką wspinaczkową przez personel}
\titleEN{Rock Gym -- Personnel Management System for a Climbing Wall}

\shorttitlePL{Rock Gym -- system zarządzania ścianką wspinaczkową przez personel}
\shorttitleEN{Rock Gym -- Personnel Management System for a Climbing Wall}
...
\include{chapters/chapter010}
\include{chapters/chapter011}
\include{chapters/chapter012}
\nocite{*}
%------------------------------------------------------------------------------
